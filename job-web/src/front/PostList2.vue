              ...
              <li v-for="(item,index) in posts" :key="index">
                <a href="#">
                  ...
                  <span style="float: right">
                                        <el-button type="primary" @click="send(item.id, item.companyId)" size="mini"
                                                   round>申请职位</el-button>
                                        <el-button type="danger" @click="favor(item.id, item.companyId)" size="mini"
                                                   round>收藏职位</el-button>
                                        <el-button type="text" @click="showChart">职位描述</el-button>
                                      <detail v-if="showChartFlag"></detail>
                                    </span>
                </a>
                <p>
...
import detail from '../front/Detail2.vue';
